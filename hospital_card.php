  ...
  <div class="cards">
    ...
    <div class="card">
      ...
      <div class="card-desc">
        ...
        <p class="link">
          <a href="https://www.apollospectra.com/our-hospitals/gwalior/vikas-nagar/best-hospital-in-vikas-nagar-gwalior/">link</a>
        </p>
      </div>
    </div>
    <div class="card">
      ...
      <form action="">
        <div class="form">
          ...
          <div class="input-container ic2">
            ...
            <div class="cut"></div>
            <label for="details" class="placeholder" name="details" required>Address</label>
          </div>
