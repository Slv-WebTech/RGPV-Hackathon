...
<html lang="en">
  ...
  <body>
    ...
    <section
      id="team"
      class="animate__animated wow animate__flip text-gray-600 body-font"
    >
      <div class="container px-5 py-24 mx-auto">
        <div class="flex flex-col text-center w-full mb-20">
          <h1
          ...
          <p class="mx-auto leading-relaxed text-base">
            <em style="font-size: 14px">
              <q
                >This website is a group project for State level hackathon 1.0
                organized by</q
              >:-
              <br />
              <strong>Rajiv Gandhi proudyogiki Vishwavidyalaya,Bhopal</strong
              ><br />
